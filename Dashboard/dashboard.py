...
BASE_PATH = "C:/Users/arel/Documents/Dicoding Data Science/Dashboard/"
...
def load_data():
    ...
    try:
        ...
        st.error(f"File {file_path} tidak ditemukan. Pastikan file sudah ada di lokasi yang benar.")
        return None
